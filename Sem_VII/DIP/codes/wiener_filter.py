...
filename = './images/DIP3E_CH05_Original_Images/FigP0520(blurred-heart).tif'
...
if __name__ == '__main__':
    ...
    label = ['Original Image', 'Motion Blurred Image',
             'Motion Blurring Image', 'Wiener Filtering Image']
