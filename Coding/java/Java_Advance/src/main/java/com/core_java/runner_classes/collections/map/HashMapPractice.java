...
import com.core_java.models.StudentObject;
...
public class HashMapPractice implements CodeRunnerInterface {
    public static void main(String[] args) {
        ...
        // basically, both s1 and s2 are the same student, but by equals method
        ...
        // capacity --> more capacity less collisions
        // load factor --> higher load factor --> less frequently resizing but higher collisions
        //             --> lower load factor --> more frequently resizing but lower collisions
    }
