package com.core_java.runner_classes.collections.list;
...
public class VectorPractice implements CodeRunnerInterface {
    ...
    public static void main(String[] args) {
        ...
        // enumeration (it is only read-only and not able modify elements inside the iteration)
        // also it is legacy class
        System.out.println("\nEnumeration");
        ...
        // we can delete elements while traversing in iterator class.
        // iterator class allows modifying while iterating
    }
}
